...
class AppConfiguration:
    ...
    def get_data_validation_config(self) -> DataValidationConfig:
        ...
        books_csv_file_dir = os.path.join(
            artifacts_dir, dataset_dir, data_ingestion_config['ingested_dir'], data_validation_config['books_csv_file']
        )
        ratings_csv_file_dir = os.path.join(
            artifacts_dir, dataset_dir, data_ingestion_config['ingested_dir'], data_validation_config['ratings_csv_file']
        )
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        ...
        clean_data_file_path = os.path.join(
            artifacts_dir, dataset_dir, data_validation_config['clean_data_dir'], 'clean_data.csv'
        )
        transformed_data_dir = os.path.join(
            artifacts_dir, dataset_dir, data_transformation_config['transformed_data_dir']
        )
    ...
    def get_model_trainer_config(self) -> ModelTrainerConfig:
        ...
        transformed_data_file_dir = os.path.join(
            artifacts_dir, dataset_dir, data_transformation_config['transformed_data_dir'], 'transformed_data.pkl'
        )
    ...
    def get_recommendation_config(self) -> ModelRecommendationConfig:
        ...
        book_name_serialized_objects = os.path.join(
            artifacts_dir, data_validation_config['serialized_objects_dir'], 'book_names.pkl'
        )
        book_pivot_serialized_objects = os.path.join(
            artifacts_dir, data_validation_config['serialized_objects_dir'], 'book_pivot.pkl'
        )
        final_rating_serialized_objects = os.path.join(
            artifacts_dir, data_validation_config['serialized_objects_dir'], 'final_rating.pkl'
        )
